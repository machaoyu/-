    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/user-list.do/1/3">用户管理</a></li>
            ...
            <div class="box-body">
                ...
                <div class="tab-pane" id="tab-treetable">
                    <table id="collapse-table" class="table table-bordered table-hover dataTable">
                        ...
                        <tr data-tt-id="0">
                            <td colspan="2">${requestScope.user.username}</td>
                        </tr>
                        <tbody>
                        <c:forEach items="${requestScope.user.roleList}" var="role">
